...
const getValues = function () {
    ...
    quote.productName = DOM.nutmegGrade.textContent;
...
export class View {
    ...
    handleBtnDownload() {
        DOM.sectionQuote.addEventListener('click', function (e) {
            e.preventDefault();
            ...
            doc.html(html, {
                callback: function (doc) {
                    ...
                    // doc.save(`Celexport Quotation - ${this.data.fullName}.pdf`);
                    doc.save(`Celexport Quotation - ${quote.fullName}.pdf`);
                },
                x: 1,
                y: 1
            });
    ...
    async renderBtnQuote() {
        ...
        await postQuote(quote.quoteNumber, quote.validStart, quote.validEnd, quote.productName, quote.quantity, quote.container, quote.weightTon,
            quote.incoterms, quote.portDischarge, quote.country.at, quote.paymentMethod,
            quote.kurs, quote.fobRp, quote.fobUsd, quote.fobTon, quote.fullName, quote.companyName, quote.email);
    }
                ...
                <div class="quoteLeft">
                    ...
                    <div class="quoteLeft__list quoteLeft__list--2">
                        ...
                        <ul>
                            ...
                            <li>Quality: <a href="/nutmeg" target="blank"><b><em>See Product Catalog</em></b></a></li>
                    ...
                    <div class="quoteCTA">
                        <p>For more quote request please <a href='/api/v1/quote'><em>reload</em></a>  this page. <br> If you want to proceed further with this offer or have any other enquiries, kindly to contact me.</p>
...
export const renderQuote = function () {
    ...
    // await postQuote(quote.quoteNumber, quote.validStart, quote.validEnd, quote.productName, quote.quantity, quote.weightTon,
    //     quote.container, quote.incoterms, quote.portDischarge, quote.country.at, quote.paymentMethod,
    //     quote.kurs, quote.fobRp, quote.fobUsd, quote.fobTon, quote.fullName, quote.companyName, quote.email);
